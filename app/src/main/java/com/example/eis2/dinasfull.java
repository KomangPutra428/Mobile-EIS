...
public class dinasfull extends AppCompatActivity {
    EditText tanggal, tanggalakhir;
    ImageButton lihat, tambah, hapus;
    ProgressDialog pDialog;

    public static ListView list;
    private List<dinasfulldaymodel> movieItemList2;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_dinasfull);
        ...
        tanggal.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                DatePickerDialog datePickerDialog = new DatePickerDialog(dinasfull.this, dateSetListener, currentDate.get(Calendar.YEAR), currentDate.get(Calendar.MONTH), currentDate.get(Calendar.DAY_OF_MONTH));
                    ...
                    alertDialogBuilder
                            ...
                            .setPositiveButton("Ya", new DialogInterface.OnClickListener() {
                                ...
                                public void onClick(DialogInterface dialog, int id) {
                                    ...
                                    editor.clear();
                                    editor.apply();
                                    Intent intent = new Intent(dinasfull.this, MainActivity.class);
    ...
    private void listdinasfullday() {
        pDialog = new ProgressDialog(dinasfull.this);
        showDialog();
        ...
        StringRequest stringRequest = new StringRequest(Request.Method.GET, "https://hrd.tvip.co.id/rest_server/pengajuan/dinas_full_day?nik_baru=" + nik_baru,
                    ...
                    public void onResponse(String response) {
                        ...
                        try {
                            ...
                            for (int i = 0; i < movieArray.length(); i++) {
                                ...
                                final dinasfulldaymodel movieItem2 = new dinasfulldaymodel(
                                ...
                                Collections.sort(movieItemList2, new Comparator<dinasfulldaymodel>() {
                                    public int compare(dinasfulldaymodel o1, dinasfulldaymodel o2) {
                            ...
                            ListViewAdapterDinasFull adapter = new ListViewAdapterDinasFull(movieItemList2, getApplicationContext());
    ...
    public static class ListViewAdapterDinasFull extends ArrayAdapter<dinasfulldaymodel> {

        List<dinasfulldaymodel> movieItemList2;

        private Context context;

        public ListViewAdapterDinasFull(List<dinasfulldaymodel> movieItemList2, Context context) {
            super(context, R.layout.list_item_dinas_fullday, movieItemList2);
        ...
        public View getView(int position, View convertView, ViewGroup parent) {
            ...
            dinasfulldaymodel movieItem2 = getItem(position);
            ...
            karyawan.setText(movieItem2.getKaryawan_pengganti());
