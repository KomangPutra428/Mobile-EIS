...
public class onoff_team extends AppCompatActivity {
    ListView list;
    EditText namaedit;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_onoff_team);
                    ...
                    alertDialogBuilder
                            ...
                            .setPositiveButton("Ya", new DialogInterface.OnClickListener() {
                                ...
                                public void onClick(DialogInterface dialog, int id) {
                                    ...
                                    editor.clear();
                                    editor.apply();
                                    Intent intent = new Intent(onoff_team.this, MainActivity.class);
    ...
    private void shiftinglist() {
        ...
        StringRequest stringRequest = new StringRequest(Request.Method.GET, "https://hrd.tvip.co.id/rest_server/pengajuan/shifting/index?nik_baru=" + nik_baru,
                new Response.Listener<String>() {
                    @Override
                    public void onResponse(String response) {
                        ...
                        try {
                            ...
                            for (int i = 0; i < movieArray.length(); i++) {
                                ...
                                if(!movieObject.getString("waktu_masuk").equals("00:00") && !movieObject.getString("waktu_keluar").equals("00:00")){
                                ...
                                onoff_team.ListViewAdapterShiftingTeam adapter = new onoff_team.ListViewAdapterShiftingTeam(movieItemList, getApplicationContext());
...
//            }
            ...
            edit.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View v) {
                    Intent i = new Intent(onoff_team.this, form_onoff.class);
                    ...
                    alertDialogBuilder
                            ...
                            .setPositiveButton("Ya", new DialogInterface.OnClickListener() {
                                ...
                                public void onClick(DialogInterface dialog, int id) {
                                    ...
                                    pDialog = new ProgressDialog(onoff_team.this);
                                    showDialog();
                                    ...
                                    RequestQueue requestQueue = Volley.newRequestQueue(onoff_team.this);
                                    requestQueue.add(stringRequest);
                                }
                            })
                            .setNegativeButton("Tidak", new DialogInterface.OnClickListener() {
