...
public class spv_surat_keterangan_kerja extends AppCompatActivity {
    ImageButton formsk, listsk, approvalsk;
    TextView hari_ini;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setNavigationDrawer();
        formsk = (ImageButton) findViewById(R.id.formsk);
        listsk = (ImageButton) findViewById(R.id.listsk);
        approvalsk = (ImageButton) findViewById(R.id.approvalsk);
