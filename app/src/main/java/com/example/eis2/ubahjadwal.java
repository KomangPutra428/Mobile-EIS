...
public class ubahjadwal extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_ubahjadwal);
        ...
        editjam.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                mTimePicker = new TimePickerDialog(ubahjadwal.this, new TimePickerDialog.OnTimeSetListener() {
                    @Override
        ...
        tanggaledit.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                // TODO Auto-generated method stub
                new DatePickerDialog(ubahjadwal.this, datePickerDialog, myCalendar
        ...
        StringRequest stringRequest = new StringRequest(Request.Method.GET, "https://hrd.tvip.co.id/mobile_eis_2/depo.php", new Response.Listener<String>() {
            ...
            public void onResponse(String response) {
                try {
                    ...
                    pilihdepo.setAdapter(new ArrayAdapter<String>(ubahjadwal.this, android.R.layout.simple_spinner_dropdown_item, depoarray));
    ...
    private void getform() {
        ...
        StringRequest stringRequest = new StringRequest(Request.Method.GET, "https://hrd.tvip.co.id/rest_server/website/jadwal/index?id=" + idkaryawan,
                    ...
                    public void onResponse(String response) {
                        ...
                        try {
                            ...
                            for (int i = 0; i < movieArray.length(); i++) {
                                ...
                                position.setText(movieObject.getString("posisi"));
                                noktp.setText(movieObject.getString("no_ktp"));
                                name.setText(movieObject.getString("nama_lengkap"));
    ...
    private void jabatan() {
        ...
        RequestQueue requestQueue = Volley.newRequestQueue(ubahjadwal.this);
        requestQueue.add(stringRequest);
    }
                    ...
                    alertDialogBuilder
                            ...
                            .setPositiveButton("Ya", new DialogInterface.OnClickListener() {
                                ...
                                public void onClick(DialogInterface dialog, int id) {
                                    ...
                                    editor.clear();
                                    editor.apply();
                                    Intent intent = new Intent(ubahjadwal.this, MainActivity.class);
    ...
    private void postjadwal() {
        ...
        StringRequest stringRequest2 = new StringRequest(Request.Method.PUT, "https://hrd.tvip.co.id/rest_server/website/jadwal/index_jadwal",
                new Response.Listener<String>() {
                    @Override
                    public void onResponse(String response) {
                        Toast.makeText(getApplicationContext(), "data sudah dimasukkan", Toast.LENGTH_LONG).show();
                        ubahjadwal.this.finish();
                    }
                },
                new Response.ErrorListener() {
                    @Override
            ...
            protected Map<String, String> getParams() throws AuthFailureError {
                ...
                params.put("id", getIntent().getStringExtra(KEY_NIK));
