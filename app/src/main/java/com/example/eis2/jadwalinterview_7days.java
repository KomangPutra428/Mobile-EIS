...
import static com.example.eis2.Item.LoginItem.KEY_NAMA;
import static com.example.eis2.Item.LoginItem.KEY_NIK;
import static com.example.eis2.Item.LoginItem.NIK_TEAM;
import static com.example.eis2.Item.LoginItem.id_interview;
            ...
            if(movieItem.getNama_pewawancara_1().equals("null")){
                ...
                interview.setOnClickListener(new View.OnClickListener() {
                    ...
                    public void onClick(View v) {
                        ...
                        i.putExtra(NIK_TEAM, nik_baru);
                        i.putExtra(KEY_JABATAN, idjabatan);
