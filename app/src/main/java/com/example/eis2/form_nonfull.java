...
import com.example.eis2.Item.nonfullmodel;
...
public class form_nonfull extends AppCompatActivity implements RadioGroup.OnCheckedChangeListener {
    TextView no, tgl;
    private List<nonfullmodel> movieItemList;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_form_nonfull);
                    ...
                    alertDialogBuilder
                            ...
                            .setPositiveButton("Ya", new DialogInterface.OnClickListener() {
                                ...
                                public void onClick(DialogInterface dialog, int id) {
                                    ...
                                    editor.clear();
                                    editor.apply();
                                    Intent intent = new Intent(form_nonfull.this, MainActivity.class);
    ...
    private void approval() {
        ...
        StringRequest stringRequest = new StringRequest(Request.Method.GET, "https://hrd.tvip.co.id/rest_server/pengajuan/izin_non_full_day/index?id_non_full=" + idkaryawan,
    ...
    private void approve() {
        pDialog = new ProgressDialog(form_nonfull.this);
        showDialog();
        ...
        StringRequest stringRequest = new StringRequest(Request.Method.PUT, "https://hrd.tvip.co.id/rest_server/pengajuan/izin_non_full_day/index",
                new Response.Listener<String>() {
                    @Override
                    public void onResponse(String response) {
                        hideDialog();
                        Toast.makeText(getApplicationContext(), "sudah di update", Toast.LENGTH_LONG).show();
                        form_nonfull.this.finish();
                        postnotif();
        ...
        StringRequest stringRequest = new StringRequest(Request.Method.GET, "https://hrd.tvip.co.id/rest_server/master/Notifikasi/index_token_nik?nik_baru=" + nikbaru.getText().toString(),
                new Response.Listener<String>() {
                    ...
                    private void postNotifikasi(String device_token) {
                        final StringRequest stringRequest2 = new StringRequest(Request.Method.POST, "https://hrd.tvip.co.id/Push_Notification/push_notif_eis.php",
                            ...
                            protected Map<String, String> getParams() throws AuthFailureError {
                                ...
                                if (diterima.isChecked()) {
                                    params.put("body", "Selamat pengajuan IZIN NON FULL DAY anda sudah di APPROVE");
                                } else if (tidakterima.isChecked()) {
                                    params.put("body", "Maaf pengajuan IZIN NON FULL DAY anda NOT APPROVE");
                                }
                        ...
                        RequestQueue requestQueue2 = Volley.newRequestQueue(form_nonfull.this);
