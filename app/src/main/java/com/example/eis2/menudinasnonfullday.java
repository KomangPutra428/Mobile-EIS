...
public class menudinasnonfullday extends AppCompatActivity {
    TextView hari_ini;
    ImageButton nonfullday, rekap, approval;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_menudinasnonfullday);
        ...
        nonfullday.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent fullday = new Intent(menudinasnonfullday.this, dinasnonfullday.class);
                startActivity(fullday);
            }
        });
        ...
        rekap.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent fullday = new Intent(menudinasnonfullday.this, dinasnonfull.class);
                startActivity(fullday);
            }
        });
        ...
        approval.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent fullday = new Intent(menudinasnonfullday.this, approval_dinas_nonfull.class);
                startActivity(fullday);
            }
        });
                    ...
                    alertDialogBuilder
                            ...
                            .setPositiveButton("Ya", new DialogInterface.OnClickListener() {
                                ...
                                public void onClick(DialogInterface dialog, int id) {
                                    ...
                                    editor.clear();
                                    editor.apply();
                                    Intent intent = new Intent(menudinasnonfullday.this, MainActivity.class);
