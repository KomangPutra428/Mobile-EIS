...
public class menudinasfullday extends AppCompatActivity {
    TextView hari_ini;
    ImageButton fullday, rekap, approval;
    DrawerLayout dLayout;
    SharedPreferences sharedPreferences;
    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_menudinasfullday);
        ...
        fullday.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent fullday = new Intent(menudinasfullday.this, dinasfullday.class);
        ...
        rekap.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent fullday = new Intent(menudinasfullday.this, dinasfull.class);
                startActivity(fullday);
            }
        });
        ...
        approval.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent fullday = new Intent(menudinasfullday.this, approval_dinas_full.class);
                startActivity(fullday);
            }
        });
                    ...
                    alertDialogBuilder
                            ...
                            .setPositiveButton("Ya", new DialogInterface.OnClickListener() {
                                ...
                                public void onClick(DialogInterface dialog, int id) {
                                    ...
                                    editor.clear();
                                    editor.apply();
                                    Intent intent = new Intent(menudinasfullday.this, MainActivity.class);
