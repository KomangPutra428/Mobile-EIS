...
public class form_onoff extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_form_onoff);
                    ...
                    alertDialogBuilder
                            ...
                            .setPositiveButton("Ya", new DialogInterface.OnClickListener() {
                                ...
                                public void onClick(DialogInterface dialog, int id) {
                                    ...
                                    editor.clear();
                                    editor.apply();
                                    Intent intent = new Intent(form_onoff.this, MainActivity.class);
    ...
    private void update() {
        pDialog = new ProgressDialog(form_onoff.this);
        showDialog();
...
//                        form_onoff.this.finish();
    ...
    private void updatejam() {
        ...
        RequestQueue requestQueue2 = Volley.newRequestQueue(form_onoff.this);
        ...
        StringRequest stringRequest = new StringRequest(Request.Method.GET, "https://hrd.tvip.co.id/mobile_eis_2/jam.php", new Response.Listener<String>() {
            ...
            public void onResponse(String response) {
                try {
                    ...
                    pilihjam.setAdapter(new ArrayAdapter<String>(form_onoff.this, android.R.layout.simple_spinner_dropdown_item, jam2));
