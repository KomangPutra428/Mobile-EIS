...
public class spv_absensi extends AppCompatActivity {
    ImageButton absensipersonal, absensiteam;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setNavigationDrawer();
        absensipersonal = (ImageButton) findViewById(R.id.absensipersonal);
        absensiteam = (ImageButton) findViewById(R.id.absensiteam);
