...
public class realizationmodels {
    private String id;
    private String date;
    ...
    public realizationmodels(String id, String date, String start, String start_realisasi, String end, String end_realisasi, String ket_plan, String ket_realisasi, String status, String pengganti, String nama_kategori) {
        this.id = id;
        this.date = date;
        this.start = start;
