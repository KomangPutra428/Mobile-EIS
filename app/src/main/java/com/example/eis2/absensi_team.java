...
public class absensi_team extends AppCompatActivity  {
    ...
    private void loadTeam() {
        ...
        final StringRequest stringRequest1 = new StringRequest(Request.Method.GET, "https://hrd.tvip.co.id/rest_server/master/team/index?jabatan_struktur=" + txt_jabatan_struktur.getText().toString(),
                    ...
                    public void onResponse(String response) {
                        ...
                        try {
                            ...
                            for (int i = 0; i < movieArray.length(); i++) {
                                ...
                                if (txt_lokasi_struktur.getText().toString().equals("Pusat")) {
                                        adapter.notifyDataSetChanged();
                                }
                                if (!txt_lokasi_struktur.getText().toString().equals("Pusat")) {
                                    if (!movieObject.getString("lokasi_struktur").equalsIgnoreCase(txt_lokasi_struktur.getText().toString())) {
