...
public class menu_slipgaji extends AppCompatActivity {
    TextView hari_ini;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_menu_slipgaji);
        HttpsTrustManager.allowAllSSL();

        hari_ini = findViewById(R.id.hari_ini);
        slipgaji = findViewById(R.id.slipgaji);
        ...
        refund.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent i = new Intent (menu_slipgaji.this, menu_refund.class);
                startActivity(i);
            }
        });
    }
                    ...
                    alertDialogBuilder
                            ...
                            .setPositiveButton("Ya", new DialogInterface.OnClickListener() {
                                ...
                                public void onClick(DialogInterface dialog, int id) {
                                    ...
                                    editor.clear();
                                    editor.apply();
                                    Intent intent = new Intent(menu_slipgaji.this, MainActivity.class);
