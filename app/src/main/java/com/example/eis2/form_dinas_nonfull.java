...
import com.example.eis2.Item.formdinasnonfulldaymodel;
...
public class form_dinas_nonfull extends AppCompatActivity implements RadioGroup.OnCheckedChangeListener{
    ...
    private void getform() {
        ...
        StringRequest stringRequest = new StringRequest(Request.Method.GET, "https://hrd.tvip.co.id/rest_server/pengajuan/dinas_non_full_day/index?id_non_full=" + idkaryawan,
    ...
    private void approve() {
        ...
        StringRequest stringRequest = new StringRequest(Request.Method.PUT, "https://hrd.tvip.co.id/rest_server/pengajuan/dinas_non_full_day/index",
                new Response.Listener<String>() {
                    @Override
                    public void onResponse(String response) {
                        hideDialog();
