...
public class form_dinas_full extends AppCompatActivity implements RadioGroup.OnCheckedChangeListener {
    TextView no, tgl;
    EditText pengajuan, namakaryawan, jenisizin, tidakhadir, karyawan, keterangan2, nikbaru;
    ImageButton ceklihat, approval;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_form_dinas_full);
                    ...
                    alertDialogBuilder
                            ...
                            .setPositiveButton("Ya", new DialogInterface.OnClickListener() {
                                ...
                                public void onClick(DialogInterface dialog, int id) {
                                    ...
                                    editor.clear();
                                    editor.apply();
                                    Intent intent = new Intent(form_dinas_full.this, MainActivity.class);
    ...
    private void getForm() {
        ...
        StringRequest stringRequest = new StringRequest(Request.Method.GET, "https://hrd.tvip.co.id/rest_server/pengajuan/dinas_full_day/index?id_full_day=" + idkaryawan,
    ...
    private void approve() {
        pDialog = new ProgressDialog(form_dinas_full.this);
        showDialog();
        ...
        StringRequest stringRequest = new StringRequest(Request.Method.PUT, "https://hrd.tvip.co.id/rest_server/pengajuan/dinas_full_day/index",
                new Response.Listener<String>() {
                    @Override
                    public void onResponse(String response) {
                        hideDialog();
                        Toast.makeText(getApplicationContext(), "sudah di update", Toast.LENGTH_LONG).show();
                        form_dinas_full.this.finish();
                        postNotif();
        ...
        StringRequest stringRequest = new StringRequest(Request.Method.GET, "https://hrd.tvip.co.id/rest_server/master/Notifikasi/index_token_nik?nik_baru=" + nikbaru.getText().toString(),
                new Response.Listener<String>() {
                    ...
                    private void postNotifikasi(String device_token) {
                        final StringRequest stringRequest2 = new StringRequest(Request.Method.POST, "https://hrd.tvip.co.id/Push_Notification/push_notif_eis.php",
                            ...
                            protected Map<String, String> getParams() throws AuthFailureError {
                                ...
                                if (diterima.isChecked()) {
                                    params.put("body", "Selamat pengajuan DINAS FULL DAY anda sudah di APPROVE");
                                } else if (tidakterima.isChecked()) {
                                    params.put("body", "Maaf pengajuan DINAS FULL DAY anda NOT APPROVE");
                                }
                        ...
                        RequestQueue requestQueue2 = Volley.newRequestQueue(form_dinas_full.this);
