...
import com.example.eis2.Item.pengembalianseragammodel;
...
public class list_pengembalianseragam extends AppCompatActivity {
    ...
    private void listpengembalian() {
        ...
        StringRequest stringRequest = new StringRequest(Request.Method.GET, "https://hrd.tvip.co.id/rest_server/pengajuan/Pengembalian_seragam/index?nik_pengajuan=" + nik_baru,
    ...
    public class ListViewAdapterSeragam extends ArrayAdapter<pengembalianseragammodel> {
        ...
        public View getView(final int position, View convertView, ViewGroup parent) {
            ...
            StringRequest stringRequest2 = new StringRequest(Request.Method.GET, "https://hrd.tvip.co.id/rest_server/master/seragam/index?id_seragam=" + movieItem.getId_seragam(),
                    new Response.Listener<String>() {
                        @Override
                        public void onResponse(String response) {
