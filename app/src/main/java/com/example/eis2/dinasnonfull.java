...
import com.example.eis2.Item.dinasnonfulldaymodel;
...
public class dinasnonfull extends AppCompatActivity {
    EditText tanggal, tanggalakhir;
    ImageButton lihat, tambah, hapus;
    DrawerLayout dLayout;

    public static ListView list;
    private List<dinasnonfulldaymodel> movieItemList2;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_dinasnonfull);
        ...
        tanggal.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                DatePickerDialog datePickerDialog = new DatePickerDialog(dinasnonfull.this, dateSetListener, currentDate.get(Calendar.YEAR), currentDate.get(Calendar.MONTH), currentDate.get(Calendar.DAY_OF_MONTH));
                    ...
                    alertDialogBuilder
                            ...
                            .setPositiveButton("Ya", new DialogInterface.OnClickListener() {
                                ...
                                public void onClick(DialogInterface dialog, int id) {
                                    ...
                                    editor.clear();
                                    editor.apply();
                                    Intent intent = new Intent(dinasnonfull.this, MainActivity.class);
    ...
    private void listdinasnonfullday() {
        pDialog = new ProgressDialog(dinasnonfull.this);
        showDialog();
        ...
        StringRequest stringRequest = new StringRequest(Request.Method.GET, "https://hrd.tvip.co.id/rest_server/pengajuan/dinas_non_full_day/index?nik_baru=" + nik_baru,
                    ...
                    public void onResponse(String response) {
                        ...
                        try {
                            ...
                            for (int i = 0; i < movieArray.length(); i++) {
                                ...
                                final dinasnonfulldaymodel movieItem2 = new dinasnonfulldaymodel(
                                ...
                                if(dtend2 == null){
                                    if(!date2.equals(date1)){
                                        movieItemList2.remove(movieItem2);
                                    }
                                } else {
                                ...
                                Collections.sort(movieItemList2, new Comparator<dinasnonfulldaymodel>() {
                                    public int compare(dinasnonfulldaymodel o1, dinasnonfulldaymodel o2) {
                            ...
                            ListViewAdapterDinasNonFull adapter = new ListViewAdapterDinasNonFull(movieItemList2, getApplicationContext());
    ...
    public static class ListViewAdapterDinasNonFull extends ArrayAdapter<dinasnonfulldaymodel> {

        List<dinasnonfulldaymodel> movieItemList2;

        private Context context;

        public ListViewAdapterDinasNonFull(List<dinasnonfulldaymodel> movieItemList2, Context context) {
            super(context, R.layout.list_item_dinas_nonfull, movieItemList2);
        ...
        public View getView(int position, View convertView, ViewGroup parent) {
            ...
            TextView jenis = listViewItem.findViewById(R.id.jenis_izin);
            ...
            dinasnonfulldaymodel movieItem2 = getItem(position);

            tanggal_2.setText(convertFormat(movieItem2.getTanggal_absen()));
            id.setText(movieItem2.getNo_pengajuan_full_day());
            name.setText(movieItem2.getNama_karyawan_struktur());
            jenis.setText(movieItem2.getJenis_full_day());
            tidakhadir.setText(convertFormat(movieItem2.getTanggal_absen()));
            deadline.setText(convertFormat2(movieItem2.getTanggal_deadline()));
            keterangan.setText(movieItem2.getKet_tambahan());
            feedback1.setText(movieItem2.getFeedback_full_day());
            feedback2.setText(movieItem2.getFeedback_full_day_2());

            if ("0".equalsIgnoreCase(movieItem2.getStatus_full_day())) {
                approval1.setImageResource(R.drawable.btn_open);
            }
            if ("1".equalsIgnoreCase(movieItem2.getStatus_full_day())) {
                approval1.setImageResource(R.drawable.btn_aprv);
            }
            if ("2".equalsIgnoreCase(movieItem2.getStatus_full_day())) {
                approval1.setImageResource(R.drawable.btn_notaprv);
            }
            if ("3".equalsIgnoreCase(movieItem2.getStatus_full_day())) {
                approval1.setImageResource(R.drawable.btn_hangus);
            }

            if ("0".equalsIgnoreCase(movieItem2.getStatus_full_day_2())) {
                approval2.setImageResource(R.drawable.btn_open);
            }
            if ("1".equalsIgnoreCase(movieItem2.getStatus_full_day_2())) {
                approval1.setImageResource(R.drawable.btn_aprv);
            }
            if ("2".equalsIgnoreCase(movieItem2.getStatus_full_day_2())) {
                approval1.setImageResource(R.drawable.btn_notaprv);
            }
            if ("3".equalsIgnoreCase(movieItem2.getStatus_full_day_2())) {
                approval1.setImageResource(R.drawable.btn_hangus);
            }
